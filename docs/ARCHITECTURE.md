...
- `core/integrations/specialist_health.py` executa um preflight curto com cache de saude para FleetIntel/BrazilCNPJ antes de qualquer delegacao externa lenta, usando o mesmo bundle dinamico do consumer sync
